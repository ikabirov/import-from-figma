...
declare function saveTailwindColors(content: string): void;
...
export { initializeReactResource, saveColorTheme, saveFontsCss, saveIconComponent, saveIconSvg, saveIconsIndex, saveTailwindColors, };
