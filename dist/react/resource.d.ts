...
declare function saveTailwindFonts(content: string): void;
...
export { initializeReactResource, saveColorTheme, saveFontsCss, saveIconComponent, saveIconSvg, saveIconsIndex, saveTailwindColors, saveTailwindFonts, };
